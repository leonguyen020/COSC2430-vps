...
class ProjectManagement extends Component {
  ...
  onDelete = _id => {
    request("http://localhost:5000/api/projects/delete-project/" + _id, {
      method: "DELETE",
    }).then(response => {
  ...
  onEdit = (_id, data) => {
    request("http://localhost:5000/api/projects/edit-project/" + _id, {
      method: "PUT",
      body: data,
    }).then(response => {
  ...
  onAdd = item => {
    ...
    if (checkProperties(item)) {
      request("http://localhost:5000/api/projects/create-new-project", {
        method: "POST",
        body: item,
      }).then(response => {
        // console.log(response)
