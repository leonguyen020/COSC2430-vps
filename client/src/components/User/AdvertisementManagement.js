...
class AdvertisementManagement extends Component {
  ...
  componentDidMount() {
    request("http://http://localhost:5000/api/advertisements/get-advertisements", {
      method: "GET",
    }).then(response =>
      this.setState({
        data: response,
    ...
    request("http://http://localhost:5000/api/realEstates/get-real-estates", {
      method: "GET",
    }).then(response =>
      this.setState({
    ...
    request("http://http://localhost:5000/api/advertisements/areas/get-areas", {
      method: "GET",
    }).then(response =>
      this.setState({
        areas: response,
  ...
  onDelete = _id => {
    request("http://http://localhost:5000/api/advertisements/delete-ad/" + _id, {
      method: "DELETE",
    }).then(response => {
  ...
  onEdit = (_id, data) => {
    // console.log(data)
    request("http://http://localhost:5000/api/advertisements/edit-ad/" + _id, {
      method: "PUT",
      body: data,
    }).then(response => {
  ...
  onAdd = item => {
    ...
    if (checkProperties(item)) {
      request("http://http://localhost:5000/api/advertisements/create-new-ad", {
        method: "POST",
        body: item,
      }).then(response => {
        // console.log(response)
